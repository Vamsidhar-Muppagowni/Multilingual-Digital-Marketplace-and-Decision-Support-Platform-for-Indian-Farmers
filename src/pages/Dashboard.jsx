      ...
      <section className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-emerald-600 to-emerald-800 text-white shadow-xl">
        ...
        <div className="relative p-8 md:p-12 z-10">
          ...
          <p className="text-emerald-100 text-lg max-w-2xl mb-8">
            Manage your farm operations, access market prices, and stay updated with the latest agricultural schemes—all in one place.
          </p>
          <div className="flex flex-wrap gap-4">
            <div className="flex items-center gap-3 bg-white/20 backdrop-blur-sm p-4 rounded-xl">
              ...
              <div>
                <div className="text-sm text-emerald-100">Today's Weather</div>
                <div className="font-semibold text-xl">28°C, Sunny</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white/20 backdrop-blur-sm p-4 rounded-xl">
              <TrendingUp className="text-emerald-300" size={32} />
              <div>
                <div className="text-sm text-emerald-100">Market Trend</div>
                <div className="font-semibold text-xl">+5% Growth</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <Link to={action.path} key={index} className="group">
              <Card hoverEffect className="h-full p-6 flex flex-col justify-between border-t-4 border-t-transparent hover:border-t-emerald-500">
                ...
                <div className="flex items-center text-sm font-semibold text-emerald-600 group-hover:gap-2 transition-all">
                  Access Now <ArrowRight size={16} className="opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
              </Card>
            </Link>
          ))}
        ...
        <div className="lg:col-span-2">
          <Card className="p-6 h-full">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link to="/marketplace" className="text-emerald-600 font-medium hover:underline">View Marketplace</Link>
            </div>
          ...
          <Card className="p-6 h-full bg-gradient-to-br from-amber-50 to-orange-50 border-amber-100">
            ...
            <ul className="space-y-4">
              <li className="flex gap-3 items-start">
                ...
                <p className="text-sm text-gray-700">Complete your profile to get personalized scheme recommendations.</p>
              </li>
              <li className="flex gap-3 items-start">
                <div className="w-2 h-2 mt-2 rounded-full bg-amber-500 shrink-0" />
                <p className="text-sm text-gray-700">Check price trends for Potato before verify your listed crop.</p>
              </li>
            </ul>
            <Button variant="secondary" className="w-full mt-6">Update Profile</Button>
          </Card>
        </div>
      </section>
    </div>
